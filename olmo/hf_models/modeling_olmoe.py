...
from olmo.hf_models.olmoe.modeling import *
...
class OlmoeForCausalLM(OlmoePreTrainedModel, GenerationMixin):
    ...
    @replace_return_docstrings(output_type=MoeCausalLMOutputWithPast)
    def forward(
        self,
        input_ids: Optional[torch.LongTensor] = None,
        attention_mask: Optional[torch.Tensor] = None,
...
from transformers import AutoModelForCausalLM, MODEL_FOR_CAUSAL_LM_MAPPING
